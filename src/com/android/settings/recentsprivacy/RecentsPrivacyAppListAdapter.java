...
public class RecentsPrivacyAppListAdapter extends BaseAdapter implements SectionIndexer {
    ...
    //constructor
    public RecentsPrivacyAppListAdapter(Context context, List<AppInfo> apps,
        ...
        new LoadIconsTask().execute(apps.toArray(new RecentsPrivacyManager.AppInfo[]{}));
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            appHolder = (RecentsPrivacyAppViewHolder) convertView.getTag();
        }

        RecentsPrivacyManager.AppInfo app = mApps.get(position);
        ...
        int privacyGuardDrawableResId = app.recentsPrivacyEnabled
    ...
    private class LoadIconsTask extends AsyncTask<RecentsPrivacyManager.AppInfo, Void, Void> {
        @Override
        protected Void doInBackground(RecentsPrivacyManager.AppInfo... apps) {
            for (RecentsPrivacyManager.AppInfo app : apps) {
                try {
